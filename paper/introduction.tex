...
Then we have utilized this profiler to identify the root cause of performance difference in existing allocators, such as Linux, OpenBSD, DieHarder, or Hoard, or TCMalloc. Then shows the internal reason of why some are slower than others. 
