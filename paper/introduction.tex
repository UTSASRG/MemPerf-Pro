...
The memory allocator plays an important role in the performance of applications, which could be as large as 2$\times$ performance difference.  
...
Having this profiler will serve two purposes. First, it will help the designers and developers that could discover the issues of memory allocators, without the need of porting or developing the profiler for a specific allocator. Second, it will help users to choose different memory allocators, whenever 
