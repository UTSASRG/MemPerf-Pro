...
\MP{} using two benchmark suites, Phonix and PARSEC, and four synthetics applications. The performance overhead can be seen in Figure~\ref{fig:overhead}. 

For this figure, we can see that \MP{} runs $2.6\times$ slower than the default allocator. Multiple reasons may contribute to the overhead. 
