...
\MP{} aims to identify all important factors of memory allocators, as described in Section~\ref{sec:factors}. \MP{} not only uncovers potential issues, but also present some specific reasons of issues that could help programmers to solve these issues. 
This Section talks about the basic idea of \MP{}, technical challenges, and related techniques.  
