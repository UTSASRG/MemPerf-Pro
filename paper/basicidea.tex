...
Overall, \MP{} reports all metrics listed in Table~\ref{table:metrics}, by employing either RDTSC or PMUs techniques. The reported data, when combined together, explains the performance, scalability, memory consumption of an allocator. 
